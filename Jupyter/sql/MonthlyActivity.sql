...
WHERE ld.CreateDate > {start} and ld.CreateDate <= {end} and ld.Company = 'JPMC' and ld.DiscrepQty <> 0
UNION ALL
--Part3
...
WHERE da.ActionDate > {start} and da.ActionDate <= {end} and (da.ActionType = 'R' OR da.DestinationType = 'M') and da.JobNum <> '' and da.Company = 'JPMC' and dh.JobNum <> ''
